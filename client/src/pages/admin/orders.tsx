...
const statusFlow: OrderStatus[] = ["received", "preparing", "cooking", "ready", "served"];

const statusActions: Record<OrderStatus, { next: OrderStatus; label: string; icon: typeof Clock }> = {
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  <AnimatePresence mode="popLayout">
                    {filteredOrders.map((order, index) => {
                      const action = statusActions[order.status as OrderStatus];
                        ...
                        >
                          <Card
                            className={cn(
                              ...
                              order.status === "received" && "animate-pulse-glow"
                            )}
